...
public class DataBaseSettingsController {
    ...
    public DataBaseSettingsController() throws SQLException {
    }
    ...
    public void createGroup() throws SQLException {
        groupToDb.addGroup("Math");
        groupToDb.addGroup("Physics");
        groupToDb.addGroup("Code");
    }

    public void createExercises() throws SQLException {
        int id = groupToDb.checkId("Loop");
        int id2 = groupToDb.checkId("Tab");
        int id3 = groupToDb.checkId("Code");
